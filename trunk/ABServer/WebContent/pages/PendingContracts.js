 ...
 var sm = new Ext.grid.CheckboxSelectionModel();
    ...
    // custom or reusable ColumnModels
      var colModel = new Ext.grid.ColumnModel([sm,
      	{header: "Proposal ID", width: 130, sortable: true, locked:false, dataIndex: 'proposalID'},
        ...
        {header: "Proposal Rate Type", width: 120, sortable: true, dataIndex: 'contractRateType'},
        ...
        {header: "Proposal Total Price", width: 120, sortable: true, dataIndex: 'contractTotalPrice'}
    ]);
...
window.location = '../JSP/editProposal.jsp?contractid='+selections[0].id;
});
...
//myGrid.getView().refresh();
 ...
 /********************************************************************/
  ...
  function confirmDeleteContract(){
    ...
    {
      Ext.MessageBox.confirm('Confirmation','Are you sure you want to delete this Proposal?', deleteContracts);
    } else if(myGrid.selModel.getCount() > 1){
      Ext.MessageBox.confirm('Confirmation','Are you sure you want to delete those Proposals?', deleteContracts);
    } else {
