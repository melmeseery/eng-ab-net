...
Ext.onReady(function() {
	...
	var Competencesaddressed  = Ext.data.Record.create([
      {name: 'competencesAddressedName', type: 'string'},
      {name: 'idCompetencesAddressed', type: 'int'}
     ]);
    ...
    var ds = new Ext.data.Store({
      ...
      reader: new Ext.data.XmlReader({
        ...
        sortInfo:{field: "competencesAddressedName", direction: "ASC"}
      });
    ...
    // custom or reusable ColumnModels
      var colModel = new Ext.grid.ColumnModel([
      	{header: "Competence Addressed Name", width: 180, sortable: true, locked:false, dataIndex: 'competencesAddressedName'}
    ]);
...
//myGrid.getView().refresh();
 ...
 /********************************************************************/
  ...
  function confirmDeleteCourses(){
    ...
    {
      Ext.MessageBox.confirm('Confirmation','Are you sure you want to delete this Competence Addressed?', deleteCourses);
    } else if(myGrid.selModel.getCount() > 1){
      Ext.MessageBox.confirm('Confirmation','Are you sure you want to delete those Competences Addressed?', deleteCourses);
    } else {
