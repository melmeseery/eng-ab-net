	...
	var ds = new Ext.data.Store({
				...
				reader : new Ext.data.XmlReader({
							totalRecords : "results", // The element which
														...
														// dataset size
														// (optional)
							record : "Audiencetypes", // The repeated element
														// which contains row
														// information
							id : "idAudienceTypes"
						}, Audiencetypes),
	...
	function confirmDeleteCourses() {
												...
												// selected here
		{
			Ext.MessageBox.confirm('Confirmation',
					'Are you sure you want to delete this Audience Type?',
					deleteCourses);
		} else if (myGrid.selModel.getCount() > 1) {
			Ext.MessageBox.confirm('Confirmation',
					'Are you sure you want to delete those Audience Types?',
					deleteCourses);
		} else {
			Ext.MessageBox
					.alert('Uh oh...',
