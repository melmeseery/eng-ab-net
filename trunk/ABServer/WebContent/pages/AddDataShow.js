...
Ext.onReady(function(){
   ...
   var Datashowsmaintainance  = Ext.data.Record.create([
      ...
      {name: 'datashowsMaintainanceCost', type: 'int'},
      {name: 'datashowsMaintainanceDate', type: 'boolean'},
...
//myGrid.getView().refresh();
                ...
                handler:function(){ 
                	if(CostField.isValid()  && DateField.isValid() && ReasonField.isValid() )
                	{
                 			 var record = new Ext.data.Record({
								  ...
								  datashowsMaintainanceDate:   		DateField.getValue().format('d-M-Y'),
 ...
 //////////////********display form functions********************/////////////////   
  ...
  if(!AddTAWindow.isVisible()){
    ...
    function isDatashowFormValid(){//alert(NameField.isValid()+' '+PriceField.isValid()+' '+PurchaseDateField.isValid());
  return(NameField.isValid() && PriceField.isValid() && PurchaseDateField.isValid());
  }        
//    var ValidField =           	    
    /*=================================================================*/
