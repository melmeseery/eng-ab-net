...
-->
	...
	></script>
	<script type="text/javascript" src="../JS/calendar/TestScript.js"></script>
...
<body>
  ...
  <tr>
    ...
    <td width="1000"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="100" align="center" valign="middle"><a href="../pages/generalCalendarInterface.jsp"><img src="../images/link_icon_2_1.gif" width="44" height="39" border=0/></a></td>
      ...
      <tr>
        <td align="center" valign="top" background="../images/tile.gif"><table class="wide" width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
